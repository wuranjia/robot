package com.ichat4j.wrj.robot.ichat4j.service.impl;
...
import com.ichat4j.wrj.robot.ichat4j.utils.Config;
import com.ichat4j.wrj.robot.ichat4j.utils.MyHttpClient;
import com.ichat4j.wrj.robot.ichat4j.utils.SleepUtils;
import com.ichat4j.wrj.robot.ichat4j.utils.enums.ResultEnum;
import com.ichat4j.wrj.robot.ichat4j.utils.enums.RetCodeEnum;
import com.ichat4j.wrj.robot.ichat4j.utils.enums.StorageLoginInfoEnum;
import com.ichat4j.wrj.robot.ichat4j.utils.enums.URLEnum;
import com.ichat4j.wrj.robot.ichat4j.utils.enums.parameters.BaseParaEnum;
import com.ichat4j.wrj.robot.ichat4j.utils.enums.parameters.LoginParaEnum;
import com.ichat4j.wrj.robot.ichat4j.utils.enums.parameters.StatusNotifyParaEnum;
import com.ichat4j.wrj.robot.ichat4j.utils.enums.parameters.UUIDParaEnum;
...
public class LoginServiceImpl implements ILoginService {
    ...
    public void getHeadImage() {
        ...
        for (int i = 0; i < friends.size(); i++) {
            ...
            // String fileName = friend.getString("NickName");//+ File.separator
            String headPicPath = core.getPath()   + "head.jpg";
    ...
    public void webWxGetContact() {
        ...
        try {
            ...
            LOG.info(JSON.toJSONString(core.getContactList()));
            return;
        } catch (Exception e) {
            LOG.error(e.getMessage(), e);
        }
