...
import com.ichat4j.wrj.robot.ichat4j.api.MessageTools;
import com.ichat4j.wrj.robot.ichat4j.beans.BaseMsg;
import com.ichat4j.wrj.robot.ichat4j.face.IMsgHandlerFace;
import com.ichat4j.wrj.robot.ichat4j.utils.enums.MsgCodeEnum;
import com.ichat4j.wrj.robot.ichat4j.utils.enums.MsgTypeEnum;
        ...
        while (true) {
            if (core.getMsgList().size() > 0 && core.getMsgList().get(0).getContent() != null) {
                if (core.getMsgList().get(0).getContent().length() > 0) {
                    ...
                    if (msg.getType() != null) {
                        try {
                            if (core.match(msg.getFromUserName())) {
